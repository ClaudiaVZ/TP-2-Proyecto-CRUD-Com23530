...
document.getElementById('formulario').addEventListener('submit', function (event) {
    ...
    //crea el OBJETO para enviar dts de formulario al servidor
    var formData = new FormData();   //valor del campo de entrada que ingresa el usuario
    formData.append('codigo', document.getElementById('codigo').value);  //agrega clave/valor al OBJETO
    ...
    //Después de realizar la solicitud POST, se utiliza el método then()maneja la respuesta del servidor.
